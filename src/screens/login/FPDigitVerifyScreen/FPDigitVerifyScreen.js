...
export default FPDigitVerifyScreen = (
  ...
  const handleInvalidPassword = props => {
  ...
  const handleInputChange = () => {
    ...
    if (numberLength === 1) {
      ...
      // Move focus to third field
      thirdDigit.current.focus();
    } else if (numberLength === 3) {
      // Move focus to fourth field
      fourthDigit.current.focus();
    } else if (numberLength === 4) {
      fourthDigit.current.blur();
    } else if (numberLength === 5) {
      fifthDigit.current.blur();
        ...
        >
          <VStack alignItems="center">
            ...
            <AuthText>
              ...
              6-digit code sent to you. If you didn't
              receive a code, please press resend.
            </AuthText>
          </VStack>
